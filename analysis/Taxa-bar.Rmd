...
In the Phylum-Genus plot above, it appears that the genus Turicibacter makes up >90% in our controls. However, we know this isn't the case if we look at the Phylum-Family plot (Turicibacteraceae is not high relative abundance). I double-check this in the section below, and Turicibacter is at no more than 23% in any sample.
