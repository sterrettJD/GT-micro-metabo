---
title: "Microbe-metabolite regressions with controls included"
...
write.csv(results_lme, "/Users/johnsterrett/Research-Projects/Reisdorph/GT-micro-metabo/analysis/microbe_metabolite_lme_results_with_GF.csv")

results_lme <- fread("/Users/johnsterrett/Research-Projects/Reisdorph/GT-micro-metabo/analysis/microbe_metabolite_lme_results_with_GF.csv")
...
ggsave("../figures/LME-microbe-metabolite-volcano_with_GF.png", plot=p, height=8, width=8)
ggsave("../figures/LME-microbe-metabolite-volcano_with_GF.pdf", plot=p, height=8, width=8)
...
dffilt_lme_bymicrobe <- results_dffilt_lme %>%
    ...
    group_by(microbe) %>%
    summarise(fdr_up=sum(sig=="FDR p < 0.05" & beta>0),
...
microbe_order <- dffilt_lme_bymicrobe$microbe[
                    order(dffilt_lme_bymicrobe$fdr_up + 
                              dffilt_lme_bymicrobe$up)]
...
ggplot(dffilt_lme_bycompound_long,
       mapping=aes(x=n, y=metabolite, fill=significance)) +
    geom_bar(position="stack", stat="identity") +
    scale_fill_manual(values=c("fdr_down"="blue", "down"="lightblue", 
                               "unchanged"="lightgrey", 
                               "up"="red", "fdr_up"="darkred")) +
    scale_y_discrete(limits=metabolite_order) + 
    theme_bw()
...
write.csv(results_lme_within, "/Users/johnsterrett/Research-Projects/Reisdorph/GT-micro-metabo/analysis/microbe_metabolite_lme_within_results_with_GF.csv")

results_lme_within <- fread("/Users/johnsterrett/Research-Projects/Reisdorph/GT-micro-metabo/analysis/microbe_metabolite_lme_within_results_with_GF.csv")
...
p <- ggplot(heatmap_df_long %>% 
    ...
    scale_color_gradient2(midpoint=0,
                          ...
                          name=expression(sign(beta)*sqrt(abs(beta)))
    ) +
    guides(size="none", alpha="none") 
p

ggsave("../figures/microbe-metabo-heatmap_with_GF.pdf", plot=p,height = 10, width = 8)
ggsave("../figures/microbe-metabo-heatmap_with_GF.png", plot=p,height = 10, width = 8)
...
ggsave("../figures/microbe-metabo-heatmap-with-unannotated_with_GF.pdf", plot=p,height = 10, width = 8)
ggsave("../figures/microbe-metabo-heatmap-with-unannotated_with_GF.png", plot=p,height = 10, width = 8)
...
write.csv(results_lme2, "/Users/johnsterrett/Research-Projects/Reisdorph/GT-micro-metabo/analysis/microbe_metabolite_lme2_results_with_GF.csv")

results_lme2 <- fread("/Users/johnsterrett/Research-Projects/Reisdorph/GT-micro-metabo/analysis/microbe_metabolite_lme2_results_with_GF.csv")
