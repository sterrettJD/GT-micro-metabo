...
run_lme_within <- function(feature_1, feature_2, scale_features=F){
    ...
    if( (coop::sparsity(as.matrix(curr_lm_df[,feature_1])) > 0.95) ||
        (coop::sparsity(as.matrix(curr_lm_df[,feature_2])) > 0.95)
    ){
