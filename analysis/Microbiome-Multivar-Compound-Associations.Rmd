...
ggsave("../figures/feols_faith_compounds_scatter.pdf", p, height=8, width=8)
ggsave("../figures/feols_faith_compounds_scatter.png", p, height=8, width=8)
```
